...
(meditations
  ...
  (= "Rich Hickey aka The Clojurer aka Go Time aka Macro Killah"
     (let [[first-name last-name & aliases]
       ...
       (clojure.string/join " aka " (concat [(str first-name " " last-name)] aliases ))))
  ...
  (= "Test Testerson, 123 Test Lane, Testerville, TX"
     ((fn [[fname lname] {:keys [street-address city state]}] 
        (clojure.string/join ", " (conj [(str fname " " lname)] street-address city state))) ["Test" "Testerson"] test-address))
